...
public class ActivityAll extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState){
        ...
        buttonHallo = findViewById(R.id.SetHallo);
        buttonGames = findViewById(R.id.SetGames);
    ...
    private void setIntent(){
        ...
        buttonHallo.setOnClickListener(v -> {
            Intent intent = new Intent(this, ActivityHallo.class);
            startActivity(intent);
        });
...
//            Intent intent = new Intent(MediaStore.ACTION_VIDEO_CAPTURE);
        ...
        buttonTelpon.setOnClickListener(view -> {
            String numberDeveloper = "083872087410";
